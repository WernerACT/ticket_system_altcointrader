        ...
        <table style="width: 100.0%;">
            <tbody>
                <tr style="padding: 0 0 0 0">
                    <td>
                        <p>Regards <br> The AltCoinTrader Team</p>
                        ...
                        <p style="text-align: center;">
                            <span>
                                <a style="text-decoration: none;" href="https://facebook.com/AltCoinTraderSA" target="_blank">
                                    <img src="{{ secure_asset('images/social/facebook.svg') }}" alt="Facebook" style="width: 22px; height: 22px;" />
                                </a>
                            </span>
                            ...
                            <span>
                                <a style="text-decoration: none;" href="https://twitter.com/AltCoinTraderSA" target="_blank">
                                    <img src="{{ secure_asset('images/social/x-twitter.svg') }}" alt="X" style="width: 22px; height: 22px;" />
                                </a>
                            </span>
                            <span style="text-decoration: none; color: white;" width="30">&nbsp;</span>
                            <span>
                                <a style="text-decoration: none;" href="https://instagram.com/AltCoinTraderSA" target="_blank">
                                    <img src="{{ secure_asset('images/social/instagram.svg') }}" alt="Instagram" style="width: 22px; height: 22px;"  />
                                </a>
                            </span>
                            <span style="text-decoration: none; color: white;" width="30">&nbsp;</span>
                            <span>
                                <a style="text-decoration: none;" href="https://www.youtube.com/AltCoinTraderSA" target="_blank">
                                    <img src="{{ secure_asset('images/social/youtube.svg') }}" alt="YouTube" style="width: 22px; height: 22px;"  />
                                </a>
                            </span>
                        </p>
                        <p style="text-align: center;">
                            ...
                            <span>
                                <a style="text-decoration: none;" href="https://apps.apple.com/za/app/altcointrader-bitcoin-crypto/id1499787588?mt=8">
                                    <img src="{{ secure_asset('images/apps/apple_custom.png') }}" alt="Download on App Store" style="height: 25px;"  />
                                </a>
                            </span>
                            <span style="text-decoration: none; color: white;" width="30">&nbsp;</span>
                            <span>
                                <a style="text-decoration: none;" href="https://appgallery.huawei.com/#/app/C103314025">
                                    <img src="{{ secure_asset('images/apps/huawei_custom.png') }}" alt="Huawei App" style="height: 25px;"  />
                                </a>
                            </span>
                        </p>
                    </td>
